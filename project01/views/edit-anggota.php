...
require_once __DIR__ . '/../models/Pegawai.php'; // Menambahkan Pegawai model
require_once __DIR__ . '/../models/KartuDiskon.php'; // Menambahkan Kartu Diskon model
...
// Menampilkan daftar pegawai dan kartu diskon
