...
require_once __DIR__ . '/../models/KartuDiskon.php'; // Model untuk KartuDiskon
require_once __DIR__ . '/../models/Pegawai.php'; // Model untuk Pegawai

use models\Anggota;
use models\KartuDiskon;
use models\Pegawai;

// Ambil data kartu diskon yang tersedia
$kartuDiskons = KartuDiskon::get();

// Ambil data pegawai yang tersedia
